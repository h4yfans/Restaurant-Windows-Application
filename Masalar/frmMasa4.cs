...
namespace ProjeLokanta
{
    public partial class frmMasa4 : Form
    {
        ...
        private void frmMasa4_Load(object sender, EventArgs e)
        {
            ...
            dgMasa4Siparis.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgMasa4Siparis.Columns[4].Visible = false;
            //dgMasa4Siparis.SelectionMode = DataGridViewSelectionMode.FullColumnSelect;
        }
        ...
        void masasiparis()
        {
            ...
            DataTable tablo = new DataTable();
            SqlDataAdapter adptr = new SqlDataAdapter("select * from masa4siparis", bag);
            bag.Open();
            adptr.Fill(tablo);
            dgMasa4Siparis.DataSource = tablo;
            bag.Close();
            dgMasa4Siparis.Columns[0].Width = 45;
            dgMasa4Siparis.Columns[1].Width = 58;
            dgMasa4Siparis.Columns[2].Width = 207;
            dgMasa4Siparis.Columns[3].Width = 75;
            dgAraUrun.RowHeadersWidth = 14;

            this.dgMasa4Siparis.Columns["Tutar"].DefaultCellStyle
           .Alignment = DataGridViewContentAlignment.MiddleRight;

            this.dgMasa4Siparis.Columns["Miktar"].DefaultCellStyle
          .Alignment = DataGridViewContentAlignment.MiddleCenter;

            int ColumnsIndex0 = 0; // Yazar burada Kolon 1'in arka plan rengini değiştirmiş.
            this.dgMasa4Siparis.Columns[ColumnsIndex0].DefaultCellStyle.BackColor = Color.Coral;


            int ColumnsIndex1 = 1; // Yazar burada Kolon 1'in arka plan rengini değiştirmiş.
            this.dgMasa4Siparis.Columns[ColumnsIndex1].DefaultCellStyle.BackColor = Color.DodgerBlue;


            int ColumnsIndex2 = 2; // Yazar burada Kolon 1'in arka plan rengini değiştirmiş.
            this.dgMasa4Siparis.Columns[ColumnsIndex2].DefaultCellStyle.BackColor = Color.Wheat;

            int ColumnsIndex3 = 3;
            this.dgMasa4Siparis.Columns[ColumnsIndex3].DefaultCellStyle.BackColor = Color.SlateGray;

            dgMasa4Siparis.RowHeadersWidth = 14;
            dgMasa4Siparis.Columns[5].Visible = false;
        ...
        private void dgAraUrun_DoubleClick(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("INSERT INTO masa4siparis(Miktar,Birim,Urun,Tutar,Tutar2) VALUES('" + dgAraUrun.CurrentRow.Cells[5].Value.ToString() + "','" + dgAraUrun.CurrentRow.Cells[4].Value.ToString() + "','" + dgAraUrun.CurrentRow.Cells[1].Value.ToString() + "', replace( '" + masaeklenoktali + "', ',' , '.') , replace( '" + masaeklenoktali + "', ',' , '.'))", bag);
            bag.Open();
        ...
        {
            if (dgMasa4Siparis.CurrentCell != null)
            {
                SqlCommand komut = new SqlCommand("DELETE FROM masa4siparis WHERE id='" + dgMasa4Siparis.CurrentRow.Cells[5].Value.ToString() + "'", bag);
                bag.Open();
                komut.ExecuteNonQuery();
                bag.Close();
                masasiparis();
        ...
        {
            SqlCommand komut = new SqlCommand("INSERT INTO masa4siparis(Miktar,Birim,Urun,Tutar) VALUES('" + dgAraUrun.CurrentRow.Cells[5].Value.ToString() + "','" + dgAraUrun.CurrentRow.Cells[4].Value.ToString() + "','" + dgAraUrun.CurrentRow.Cells[1].Value.ToString() + " (İKRAM)','" + 0 * aragrup_id + "')", bag);
            bag.Open();
            komut.ExecuteNonQuery();
            bag.Close();
            masasiparis();
        ...
        private void btnMasa2Arttır_Click(object sender, EventArgs e)
        {
            if (dgMasa4Siparis.CurrentCell != null)
            {
                aragrup_id = double.Parse(dgMasa4Siparis.CurrentRow.Cells[0].Value.ToString());
                tutar1 = decimal.Parse(dgMasa4Siparis.CurrentRow.Cells[3].Value.ToString());
                tutar2 = decimal.Parse(dgMasa4Siparis.CurrentRow.Cells[4].Value.ToString());
                decimal x;
                x = arttir + Convert.ToDecimal(aragrup_id);
                tutar1 = tutar2 * x;
                SqlCommand komut = new SqlCommand("UPDATE masa4siparis SET Miktar='" + x.ToString() + "',Birim='" + dgMasa4Siparis.CurrentRow.Cells[1].Value.ToString() + "',Urun='" + dgMasa4Siparis.CurrentRow.Cells[2].Value.ToString() + "',Tutar=replace( '" + tutar1 + "', ',' , '.') WHERE Urun='" + dgMasa4Siparis.CurrentRow.Cells[2].Value.ToString() + "'", bag);
                bag.Open();
                komut.ExecuteNonQuery();
                bag.Close();
                masasiparis();
        ...
        private void btnMasa2Azalt_Click(object sender, EventArgs e)
        {
            ...
            if (dgMasa4Siparis.CurrentCell != null)
            {
                ...
                SqlCommand komut = new SqlCommand("UPDATE masa4siparis SET Miktar='" + x.ToString() + "',Birim='" + dgMasa4Siparis.CurrentRow.Cells[1].Value.ToString() + "',Urun='" + dgMasa4Siparis.CurrentRow.Cells[2].Value.ToString() + "',Tutar=replace( '" + tutar2 + "', ',' , '.') WHERE Urun='" + dgMasa4Siparis.CurrentRow.Cells[2].Value.ToString() + "'", bag);
                bag.Open();
                komut.ExecuteNonQuery();
                bag.Close();
                masasiparis();
        ...
        void toplamtutar()
        {
            ...
            SqlCommand komut = new SqlCommand("select sum(tutar)as Tutar from masa4siparis", bag);
            bag.Open();
            lblMasa2TTutar.Text = komut.ExecuteScalar().ToString() + " TL ";
            bag.Close();
            Ortak.toplamtutar4 = lblMasa2TTutar.Text;
        ...
        private void btnMasa2ServisKapa_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Servis kapatılsın mı ? Hesap: " + Ortak.toplamtutar4, "Uyarı!", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                bag.Open();
                ds.Clear();
                SqlCommand komut = new SqlCommand("UPDATE butonrenk SET ButonRengi='yesil' WHERE ButonAdi='" + frmmasa.btnMASA4.Text + "'", bag);
        ...
        private void dgMasa4Siparis_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            dgMasa4Siparis.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgMasa4Siparis.CurrentCell.Style.SelectionBackColor = Color.Black;
        }
        ...
        private void btnMasa2SiparisAl_Click(object sender, EventArgs e)
        {
            ...
            bag.Open();
            ds.Clear();
            SqlCommand komut = new SqlCommand("UPDATE butonrenk SET ButonRengi='kirmizi' WHERE ButonAdi='" + frmmasa.btnMASA4.Text + "'", bag);
            komut.ExecuteNonQuery();
            bag.Close();
            frmmasa.Show();
            frmmasa.butonrenkdenetle();
        ...
        private void dgMasa4Siparis_DoubleClick(object sender, EventArgs e)
        {
            if (dgMasa4Siparis.CurrentCell != null)
            {
                SqlCommand komut = new SqlCommand("DELETE FROM masa4siparis WHERE Urun='" + dgMasa4Siparis.CurrentRow.Cells[2].Value.ToString() + "'", bag);
                bag.Open();
                komut.ExecuteNonQuery();
                bag.Close();
                masasiparis();
